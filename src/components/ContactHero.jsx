...
const ContactHero = () => {
  ...
  return (
    <div className="relative text-center mb-24 md:mb-32 space-y-12 overflow-visible">
      {/* Efectos de fondo premium */}
      <div className="absolute inset-0 -z-10 overflow-visible">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-primary/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/4 right-1/4 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-emerald-500/5 rounded-full blur-2xl"></div>
      </div>
